...
namespace Google.Maps.Examples {
  ...
  public class BuildingLabelsCreator : MonoBehaviour {
    ...
    /// </summary>
    void OnEnable() {
      Labeller.MapController.MapsService.Events.ExtrudedStructureEvents.DidCreate.AddListener(
          OnExtrudedStructureCreated);
      Labeller.MapController.MapsService.Events.ModeledStructureEvents.DidCreate.AddListener(
    ...
    /// </summary>
    void OnDisable() {
      Labeller.MapController.MapsService.Events.ExtrudedStructureEvents.DidCreate.RemoveListener(
          OnExtrudedStructureCreated);
      Labeller.MapController.MapsService.Events.ModeledStructureEvents.DidCreate.RemoveListener(
          OnModeledStructureCreated);
    }
